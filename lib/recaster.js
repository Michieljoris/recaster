...
function conditionalRequire(options) {
    ...
    if (options.transpilerThree.denodify) denodify = require('denodify'); //https://github.com/facebook/regenerator
...
transform.denodify = function(data) {
    return VOW.kept(denodify.wrap('moduleid', data));
};
