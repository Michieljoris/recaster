...
function live_reload_code() {
    ...
    //     xhr.send(null);
    // }
    // var source = new EventSource("refresh.es");
    // source.addEventListener('message', function(e) {
    //     console.log('es message',e.data);
    // }, false);

    // source.addEventListener('open', function(e) {
    //     console.log('es open', e);
...
transform.inject = function(data) {
    ...
    var buffer = '';
    var result = streamify(data.recast).pipe(scriptInjector(live_reload_code));
